...
docker rm ddd.clinicmanagement.blazor
docker rm ddd.clinicmanagement.api
docker rm ddd.clinicmanagement-db
docker rm ddd.frontdesk.blazor
docker rm ddd.frontdesk.api
docker rm ddd.frontdesk-db
docker rm ddd.vet-clinic-public
docker rm ddd.rabbitmq
docker rm ddd.papercut
